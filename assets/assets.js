...
import brandingSection from "./branding-section.png"
import logo from "./logo-av.png"
import tshirtshero from './tshirts-hero.png'
import foodhero from './food-hero.png'
...
export const assets = {
    ...
    product_img7, product_img8, product_img9, product_img10, product_img11, product_img12,logo,brandingSection,tshirtshero,foodhero, carhero, smartwatch
}

export const categories = ["Automobile", "Fashion", "Electronics", "Clothing", "Jewelry", "Home & Kitchen", "Beauty & Health", "Home Office"];
// export const categories = ["Headphones", "Speakers", "Watch", "Earbuds", "Mouse", "Decoration", "Fashion", "Electronics", "Clothing", "Jewelry", "Home & Kitchen", "Beauty & Health", "Camera", "Home Office"];
...
export const productDummyData = [
    ...
    },
    {
        ...
        description: "Premium weight 100% organic cotton T-shirt. Designed for comfort and durability. This product is fully customizable with your own branding, text, and selected colors. Perfect for teams, events, or individual expression.",
        mrp: 35,
        price: 25,
        images: [hero_model_img, product_img1, product_img2],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
        category: "Fashion",
