...
const AddressModal = ({ setShowAddressModal }) => {
    ...
    return (
        <form onSubmit={e => toast.promise(handleSubmit(e), { loading: 'Adding Address...' })} className="fixed inset-0 z-100 bg-white/60 backdrop-blur h-screen flex items-center justify-center">
            <div className="flex flex-col gap-5 text-slate-700 w-full max-w-sm mx-6">
                ...
                <button className="bg-red-700 text-white text-sm font-medium py-2.5 rounded-full hover:bg-slate-900 active:scale-95 transition-all">SAVE ADDRESS</button>
            </div>
